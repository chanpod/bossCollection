...
angular.module('BossCollection', ['BossCollection.controllers', 'BossCollection.services', 'BossCollection.directives', 'BossCollection.accounts', 'BossCollection.filters', 'BossCollection.forums', 'BossCollection.attendance', 'BossCollection.guild', 'BossCollection.home', 'ngRoute', 'ngResource', 'ngCookies', 'ngMaterial', 'ngAnimate']).config(['$routeProvider', '$locationProvider', '$httpProvider', '$sceDelegateProvider', '$mdThemingProvider',
    function($routeProvider, $locationProvider, $httpProvider, $sceDelegateProvider, $mdThemingProvider) {
        ...
        $mdThemingProvider.theme('default').primaryPalette('legion').accentPalette('grey', {
            'default': '900'
        });
        ...
        /*
            ...
            */
        $routeProvider.when('/strategyRoom/:raid', {
        ...
        $sceDelegateProvider.resourceUrlWhitelist(['self', 'https://www.youtube.com/**', 'https://pagead2.googlesyndication.com']);
        $locationProvider.html5Mode(true);
    }
]).run([
    function() { // Check service workers are supported
...
angular.module("BossCollection.attendance", ['ngRoute']).config(['$routeProvider',
    function($routeProvider) {
        $routeProvider.when('/attendanceStatistics', {
...
angular.module("BossCollection.guild", ['ngRoute']).config(['$routeProvider',
    function($routeProvider) {
        $routeProvider.when('/auth/application', {
        ...
        var accountApi = {
            ...
            getUser: function getUser() {
                ...
                if (savedUser) {
                    ...
                    accountApi.getUserFromServer().then(function(user) {
                        if (user.guild.name == savedUser.guild.name) { //don't care
                        } else {
...
'use strict';
angular.module("BossCollection.attendance").factory('absenceService', ['$resource', '$q', '$location', '$cookies', '$rootScope', 'siteServices', '$mdMedia', '$mdDialog',
    function($resource, $q, $location, $cookies, $rootScope, siteServices, $mdMedia, $mdDialog) {
        ...
        var absenceApi = {
            getUsersAbsences: function getUsersAbsences(user) {
                var defer = $q.defer();
                UserAbsence.get({
                    userName: user
                }, function(response) {
            ...
            submitNewAbsence: function submitNewAbsence(newAbsence) {
                var defer = $q.defer();
                absence.save(newAbsence).$promise.then(function(response) {
                    defer.resolve(response);
                }, function(err) {
                    console.log(err);
                    defer.reject(err.data);
            ...
            getAbsenceHistory: function getAbsenceHistory(absenceHistory) {
                var defer = $q.defer();
                siteServices.startLoading();
                absenceHistoryResource.save(absenceHistory).$promise.then(function(response) {
                    defer.resolve(response);
                }, function(err) {
                    console.log(err);
                    defer.reject(err.data);
            ...
            saveAbsence: function saveAbsence(absence) {
                ...
                saveAbsenceResource.save(bodyData).$promise.then(function(response) {
                    siteServices.successfulUpdate();
                    defer.resolve(response);
                }, function(err) {
                    console.log(err);
            ...
            deleteAbsence: function deleteAbsence(absence) {
                ...
                deleteAbsenceResource.save(bodyData).$promise.then(function(response) {
                    siteServices.successfulUpdate();
                    defer.resolve(response);
                }, function(err) {
                    console.log(err);
            ...
            getAbsences: function getAbsences() {
                var defer = $q.defer();
                absence.get().$promise.then(function(response) {
                    defer.resolve(response);
                }, function(err) {
                    console.log(err);
                    defer.reject(err.data);
    ...
    function($scope, $location, siteServices, forumService, $mdBottomSheet, $mdDialog, data, userLoginSrvc) {
        ...
        $scope.saveForum = function() {
            ...
            if ($scope.object._id) {
                ...
                forumService.createNewForum(forum).then(function(response) {
                    $scope.close(response);
                }).
                catch (function(err) {
                    siteServices.handleError(err);
...
angular.module("BossCollection.forums").controller('forumController', ['$scope', '$location', 'siteServices', 'forumService', '$mdBottomSheet', '$mdDialog', '$window', '$timeout', 'userLoginSrvc',
    function($scope, $location, siteServices, forumService, $mdBottomSheet, $mdDialog, $window, $timeout, userLoginSrvc) {
        ...
        $scope.getForums = function() {
            $scope.loading = true;
            return forumService.getForums().then(function(forums) {
...
angular.module("BossCollection.forums").service('forumService', ['$location', '$mdDialog', '$q', '$routeParams', 'siteServices', '$mdMedia', '$rootScope', '$resource', '$cookies',
    function($location, $mdDialog, $q, $routeParams, siteServices, $mdMedia, $rootScope, $resource, $cookies) {
        ...
        function getFavorites() {
            var defer = $q.defer();
            getFavoritesResource.get().$promise.then(function(response) {
        ...
        function deleteCategory(category) {
            ...
            categoryDeleteResource.save(bodyData).$promise.then(function(result) {
                defer.resolve(result);
            }, function(err) {
                defer.reject(err);
            }).
        ...
        function createNewCategory(category) {
            ...
            categoryResource.save(bodyData).$promise.then(function(response) {
        ...
        function editCategory(category) {
            ...
            categoryEditResource.save(bodyData).$promise.then(function(response) {
                defer.resolve(response.category);
            }, function(err) {
                defer.reject(err);
            }).
        ...
        function getForum(forumId) {
            var defer = $q.defer();
            getForums().then(function(forums) {
                var selectedForum;
        ...
        function deleteForum(forum) {
            ...
            deleteForumsResource.save(bodyData).$promise.then(function(response) {
                defer.resolve(response);
            }).
            catch (function(err) {
                defer.reject(err);
        ...
        function getThreads(forumId) {
            ...
            getThreadsResource.save(bodyData).$promise.then(function(response) {
        ...
        function deleteThread(thread) {
            ...
            deleteThreadResource.save(bodyData).$promise.then(function(response) {
                defer.resolve(response);
            }).
            catch (function(err) {
                defer.reject(err);
        ...
        function createThread(thread) {
            ...
            createNewThreadResource.save(bodyData).$promise.then(function(response) {
        ...
        function getSelectedThread(threadID) {
            var defer = $q.defer();
            if (thread == undefined) {
                getThreadResource.save({
                    threadID: threadID
                }).$promise.then(function(threadData) {
        ...
        function createComment(comment) {
            ...
            createCommentResource.save(bodyData).$promise.then(function(comment) {
        ...
        function getComments(threadId, messageCount) {
            ...
            getCommentsResource.save(bodyData).$promise.then(function(comments) {
        ...
        function confirmDelete(event, callback) {
            var defer = $q.defer();
            var confirm = $mdDialog.confirm().title('Are you sure you want to delete this?').textContent('This is irreversable once you click Yes!').ariaLabel('Confirm Delete').targetEvent(event).ok('Delete').cancel('Nevermind');
...
angular.module("BossCollection.guild").factory('guildServices', ['$http', '$q', '$resource', 'siteServices', 'userLoginSrvc',
    function($http, $q, $resource, siteServices, userLoginSrvc) {
        ...
        var guildApi = {
            ...
            getRecruitment: function getRecruitment(guildName) {
                return guildRecruitmentResource.get({
                    guildName: guildName
                }).$promise;
            },
            updateRecruitment: function updateRecruitment(guildName, recruitment) {
                return guildRecruitmentResource.save({
                    guildName: guildName
                }, {
    ...
    function($scope, $location, $routeParams, $http, $timeout, siteServices, guildServices, userLoginSrvc) {
        ...
        $scope.getHomepageContent = function() {
            ...
            guildServices.getHomepageContent($scope.guildName).then(function(guild) {
                $scope.guild = guild.guild; // var sliderHTML = "<awesome-slider  height=\"x60%\" autostart=\"true\" bullets=\"true\">"
    ...
    function($scope, $location, $http, $timeout, siteServices, guildServices, userLoginSrvc) {
        ...
        $scope.getHomepageContent = function() {
            ...
            if ($scope.user && $scope.user.guild) {
                ...
                guildServices.getHomepageContent("mkdir BossCollection").then(function(guild) {
                    $scope.guild = guild.guild; // var sliderHTML = "<awesome-slider  height=\"x60%\" autostart=\"true\" bullets=\"true\">"
                    //     + "<item source=\"/images/expansionBanners/legionbanner.png\"></item>";
                    // if ($scope.guild && $scope.guild.images) {
                    //     $scope.guild.images.forEach(function (image) {
        ...
        $scope.addNewTab = function() {
            ...
            $scope.saveTab();
            $scope.newTab = Object.assign({}, newTab); //$scope.newTab = newTab; 
        };
        $scope.cancel = function() {
            $scope.editing = false;
        };
 ...
 *
 */
angular.module("BossCollection.attendance").controller("attendanceStatsCtrl", ["$scope", '$location', 'userLoginSrvc', 'absenceService', '$mdDialog', '$mdMedia', 'siteServices', '$filter', '$anchorScroll',
    function($scope, $location, userLoginSrvc, absenceService, $mdDialog, $mdMedia, siteServices, $filter, $anchorScroll) {
         ...
         *
         */
        $scope.calculateAttendance = function() { //get an object of unique users in the absence list
            var listOfUsers = _.groupBy($scope.absences, "user");
            $scope.absenceHighchartData = [];
            $scope.absenceHighchartDrillDownSeries = [];
            _(listOfUsers).forEach(function(user) { //group the users absences by type
                var absentTypes = _.groupBy(user, "type");
                var lateCount = 0;
                var absentCount = 0; //Get the number of each type
                if (absentTypes.late) {
                ...
                var lateWeight = $scope.late / $scope.absent * $scope.absent; //Get flat value by subtracting the total value minus the weighted values times the number of times they've occured a particular type. 
                ...
                var drillDownData = []; //build the drilldown data.
 ...
 *
 */
angular.module("BossCollection.attendance").controller("absenceSubmissionsController", ["$scope", '$location', 'userLoginSrvc', 'absenceService', 'siteServices', '$filter', 'guildServices',
    function($scope, $location, userLoginSrvc, absenceService, siteServices, $filter, guildServices) {
         ...
         */
        self.viewing = 0;
        self.updateSelectedMember = function(newMember) {
        ...
        self.dateHasPassed = function(absence) {
            var difference = moment().diff(moment(absence.date)); //console.log(difference);
            if (difference > 0) {
                return false;
            } else {
                return true;
        ...
        self.deleteAbsence = function(absence) {
            ...
            }).then(function(result) { //siteServices.successfulUpdate();
                if (self.viewing == 0) {
                    self.getAbsences();
                } else {
                    self.updateList();
        ...
        self.getUserAbsences = function(userName) {
            ...
            self.loading = true;
            absenceService.getUsersAbsences(userName).then(function(absences) {
                self.loading = false;
...
angular.module('BossCollection.attendance').directive('viewAbsenceReport', [
    function() {
        return {
            restrict: 'E',
            controller: 'absenceSubmissionsController as absenceReportCtrl',
...
angular.module("BossCollection.forums").controller('commentsController', ['$scope', '$routeParams', 'siteServices', 'forumService', '$mdBottomSheet', '$mdDialog', 'userLoginSrvc',
    function($scope, $routeParams, siteServices, forumService, $mdBottomSheet, $mdDialog, userLoginSrvc) {
        ...
        $scope.showModal = function(message, title) {
            $mdDialog.show($mdDialog.alert().clickOutsideToClose(false).title(title).textContent(message).ariaLabel('message popup').ok('Got it!').openFrom({
                left: -50,
                width: 30,
                height: 80
            }));
        ...
        $scope.init = function() {
            ...
            forumService.getSelectedThread(self.threadID).then(function(thread) {
                if (thread.thread) {
        ...
        self.getComments = function() {
            ...
            return forumService.getComments(self.threadID, $scope.messageCount).then(function(comments) {
                try {
                    ...
                    console.log(err);
                    if (self.thread == undefined) { //Prevent infinit loop
        ...
        $scope.deleteComment = function(comment) {
            $scope.loading = true;
            forumService.deleteComment(comment).then(function(result) {
                siteServices.successfulUpdate();
                self.getComments();
            }).
            catch (function(err) {}).
        ...
        $scope.saveComment = function() {
            ...
            forumService.createComment(comment).then(function(comment) {
...
angular.module("BossCollection.forums").controller('favoritesController', ['$scope', '$location', 'siteServices', 'forumService', '$mdBottomSheet', '$mdDialog', '$window', '$filter', '$timeout',
    function($scope, $location, siteServices, forumService, $mdBottomSheet, $mdDialog, $window, $filter, $timeout) {
        ...
        self.init = function() {
            ...
            forumService.getFavorites().then(function(favorites) {
        ...
        self.createThread = function() {
            forumService.openBottomSheet('threadEdit', {
                forum: self.favorites
            }).then(function(response) {
                self.refresh();
            });
        };
...
angular.module("BossCollection.forums").controller('threadController', ['$scope', '$location', 'siteServices', 'forumService', '$mdBottomSheet', '$mdDialog', '$window', '$filter', '$timeout',
    function($scope, $location, siteServices, forumService, $mdBottomSheet, $mdDialog, $window, $filter, $timeout) {
        ...
        $scope.init = function() {
            ...
            forumService.getCurrentForum().then(function(forum) {
                if (forum == undefined) {
        ...
        $scope.refresh = function() {
            $scope.loading = true;
            forumService.getThreads($scope.forum._id).then(function(threads) {
                $scope.loading = false;
                $scope.threads = threads;
 ...
 * @constructor No Controller
 */
angular.module("BossCollection.guild").controller("joinGuildController", ["$scope", '$location', '$http', '$timeout', 'siteServices', 'guildServices', 'userLoginSrvc', '$filter', '$mdDialog',
    function($scope, $location, $http, $timeout, siteServices, guildServices, userLoginSrvc, $filter, $mdDialog) {
        ...
        $scope.succesfullyJoinedGuild = function() {
            $mdDialog.show($mdDialog.alert().clickOutsideToClose(false).title("Success!").textContent("You will be able to access the guild services once you've been approved.").ariaLabel('message popup').ok('Got it!').openFrom({
                left: -50,
                width: 30,
                height: 80
            }).closeTo({
...
angular.module("BossCollection.guild").controller("manageMembersController", ["$scope", '$location', '$http', '$timeout', 'siteServices', 'guildServices', 'userLoginSrvc', '$filter', 'permissionsService',
    function($scope, $location, $http, $timeout, siteServices, guildServices, userLoginSrvc, $filter, permissionsService) { //user comes from parent controller navbar
        ...
        $scope.showKick = function(rank) { //(isGM() || (isOfficer() && rank.rank != 1)) && rank.rank != 0
            var shouldShowDemote = false;
            if ($scope.isGM()) {
                shouldShowDemote = true;
            } else if ($scope.isOfficer() && rank.officer != true) {
...
angular.module("BossCollection.guild").controller("applicationController", ["$scope", '$location', '$http', '$timeout', '$filter', 'realmServices', 'guildServices', 'userLoginSrvc', 'siteServices', '$mdDialog',
    function($scope, $location, $http, $timeout, $filter, realmServices, guildServices, userLoginSrvc, siteServices, $mdDialog) {
        ...
        $scope.createRaidRanks = function() {
            $scope.raidRanks = _.filter($scope.guildSelected.ranks, {
                raider: true
            });
...
angular.module("BossCollection.home").directive('recruitment', [
    function() {
        return {
            restrict: 'E',
...
angular.module("BossCollection.forums").controller('appDetailsController', ['$scope', '$location', 'siteServices', 'forumService', '$mdBottomSheet', '$mdDialog', 'data', 'userLoginSrvc', 'guildServices',
    function($scope, $location, siteServices, forumService, $mdBottomSheet, $mdDialog, data, userLoginSrvc, guildServices) {
        ...
        $scope.updateProgression = function() {
            guildServices.getProgression($scope.application.character.name, $scope.application.realm.name).then(function(result) {
                $scope.parseProgression(result);
            });
        };
        $scope.parseProgression = function(result) {
 ...
 *
 */
angular.module("BossCollection.controllers").controller("navbar", ["$scope", '$location', 'userLoginSrvc', '$rootScope', '$mdSidenav', 'siteServices', 'guildServices', 'permissionsService',
    function($scope, $location, userLoginSrvc, $rootScope, $mdSidenav, siteServices, guildServices, permissionsService) {
        ...
        $scope.loggedIn = false;
        $scope.title = "";
        $scope.reversed = false; //-ng-class = "!reversed ? 'slide' : 'slideReverse'"
        $scope.init = function() {
            getUser();
        };
        ...
        $scope.logout = function() {
            userLoginSrvc.logout().then(function(response) { //navigate to some page
                $scope.user = undefined;
            }, function(err) {
                console.log(err);
            });
        ...
        function getUser() {
            userLoginSrvc.getUser().then(function(user) {
                ...
                } catch (err) { //not sure why, but this was occasionally null when it shouldn't be.
                }
            });
        }
        $scope.init();
...
'use strict';
angular.module("BossCollection.controllers").controller("rosterController", ["$scope", 'filterFilter', 'guildServices', '$http', '$cookies', '$location', 'siteServices',
...
'use strict';
angular.module("BossCollection.controllers").controller("strategyRoomController", ['$scope',
    function($scope) {}
]);
'use strict';
angular.module("BossCollection.controllers").controller("bossStrategyController", ['$scope', 'bossStrats', '$routeParams',
    function($scope, bossStrats, routeParams) {
        ...
        $scope.currentRaid = {};
        $scope.raidToDisplay = {}; //New Boss Info
        $scope.name = "";
        $scope.url = "";
        $scope.init = function() {
            setSideNavHeight();
...
'use strict';
angular.module("BossCollection.controllers").controller("bossStrategyController", ['$scope', 'bossStrats', '$modal', '$routeParams',
...
'use strict';
angular.module("BossCollection.controllers").controller("videoController", ['$scope', 'currentUrl', '$modalInstance',
...
'use strict'; /* Directives */
angular.module('BossCollection.directives').directive('ad', ['$timeout',
    function($timeout) {
        return {
            restrict: 'E',
...
'use strict'; /* Directives */
angular.module('BossCollection.directives').directive('bossstrategies', [
    function() {
        return {
            restrict: 'E',
 ...
 * @constructor No Controller
 */
angular.module("BossCollection.filters").filter("applicants", [
    function() {
...
'use strict'; /* Filters */
angular.module('BossCollection.filters').filter('interpolate', function(version) {
...
'use strict';
angular.module("BossCollection.services").factory('permissionsService', ['$rootScope', '$mdBottomSheet', '$mdDialog', '$mdToast', '$q',
    function($rootScope, $mdBottomSheet, $mdDialog, $mdToast, $q) {
        function isGM(user, guildMembers) {
            ...
            if (user.GM != undefined) {
                ...
                if (user && user.guild) {
                    guildMember = _.find(guildMembers, {
                        user: user.name
                    });
...
'use strict';
angular.module("BossCollection.services").factory('pushNotificationsService', ['$rootScope', '$mdBottomSheet', '$mdDialog', '$mdToast', '$q', '$resource',
...
angular.module("BossCollection.services").factory('realmServices', ['$http', '$q', 'siteServices',
    function($http, $q, siteServices) {
        ...
        var realms = [];
        var realmApi = {
            getRealms: function getRealms() {
                var defer = $q.defer();
                if (realms.length == 0) {
                    $http({
                        method: 'GET',
                        url: getRealmsUrl
                    }).success(function(returnedRealms) {
                        siteServices.hideLoadingModal();
...
'use strict';
angular.module("BossCollection.services").factory('siteServices', ['$rootScope', '$mdBottomSheet', '$mdDialog', '$mdToast', '$q',
    function($rootScope, $mdBottomSheet, $mdDialog, $mdToast, $q) {
        ...
        function showMessageToast(message) {
            try {
                $mdToast.show($mdToast.simple().textContent(message).hideDelay(4000)).action('X');
            } catch (err) { //Don't care
            }
        }
        ...
        function handleError(error) {
            var defaultError = "Well, crap. Something broke and we weren't able to determine the error.";
            var message = "";
            if (error.data) {
...
'use strict';
angular.module("BossCollection.services").factory('bossStrats', ['$resource', '$q',
    function($resource, $q) {
        ...
        var bossStratsApi = {
            getStrats: function getStrats(boss) {
                var defer = $q.defer();
                console.log("Request Boss Info"); //socket.emit("getBossInfo", boss); 
                var data = {
                    name: boss
                };
            ...
            saveStrats: function saveStrats(updatedStrats, url) {
                ...
                console.log(parameters); //socket.emit("saveStrats", parameters);
...
'use strict';
angular.module("BossCollection.services").factory('socketProvider', [
    function() { //var socket = io("http://bosscollection.net:4001");
