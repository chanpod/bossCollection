    ...
    CoreModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1__angular_material__["x" /* MatTableModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_1__angular_material__["y" /* MatTabsModule */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__registration_registration_component__ = __webpack_require__("../../../../../src/app/registration/registration.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_28__registration_registration_component__["a" /* RegistrationComponent */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_15__home_newTab_component__["a" /* NewTabDialog */],
                __WEBPACK_IMPORTED_MODULE_16__home_imageUrl_component__["a" /* ImageUrlDialog */],
...
/* unused harmony export RejectedApplicationsDataSource */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var ViewApplicationsComponent = /** @class */ (function () {
    ...
    ViewApplicationsComponent.prototype.getGuildApplications = function () {
        ...
        this.guildService.getRejectedApplications()
            .subscribe(function (applications) {
            _this.loading = false;
            _this.rejectedApplications = new RejectedApplicationsDataSource(applications.applications);
        }, function (error) {
            _this.loading = false;
        });
    };
    ViewApplicationsComponent.prototype.rejectApplication = function (application) {
        var _this = this;
        var body = {
            application: application
        };
        var dialogConfig = new __WEBPACK_IMPORTED_MODULE_5__angular_material__["i" /* MatDialogConfig */]();
        dialogConfig.data = {
            message: "You are about to reject " + application.character + ". Are you sure?"
        };
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_6__confirm_dialog_confirm_dialog_component__["a" /* ConfirmDialogComponent */], dialogConfig);
        dialogRef.afterClosed().subscribe(function (result) {
            if (result == true) {
                _this.guildService.rejectApplication(body)
                    .subscribe(function (result) {
...
var RejectedApplicationsDataSource = /** @class */ (function (_super) {
    __extends(RejectedApplicationsDataSource, _super);
    function RejectedApplicationsDataSource(tableData) {
        var _this = _super.call(this) || this;
        _this.tableData = tableData;
        return _this;
    }
    /** Connect function called by the table to retrieve one stream containing the data to render. */
    RejectedApplicationsDataSource.prototype.connect = function () {
        return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["Observable"].of(this.tableData);
    };
    RejectedApplicationsDataSource.prototype.disconnect = function () { };
    return RejectedApplicationsDataSource;
}(__WEBPACK_IMPORTED_MODULE_1__angular_cdk_collections__["a" /* DataSource */]));
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.googleLogin = function () {
        ...
        gapi.auth2.getAuthInstance()
            ...
            _this.userService.checkIfNewAccount(_this.googleProfile.getId())
                .subscribe(function (result) {
                if (result) {
                    _this.oauthSignIn(_this.googleProfile.getId());
                }
                else {
                    var user = {
        ...
        this.userService.getBlizzardAccessToken(this.blizzardCode)
            ...
            if (response) {
                _this.userService.getBlizzardProfile()
                    ...
                    _this.userService.getOauthUser(profile.id)
                        .subscribe(function (result) {
                        if (result.message != "Not Found") {
                            _this.oauthSignIn(result.blizzardId);
                            _this.userService.setBlizzardUser(result);
                        }
                        else {
                            var user = {
    ...
    LoginComponent.prototype.checkIfNewAccount = function (oauthId) {
        var _this = this;
    ...
    LoginComponent.prototype.oauthSignIn = function (oauthId) {
        var _this = this;
...
module.exports = "<div class=\"row center-xs\" style=\"margin:0;\">\n\n    <mat-card>\n        <mat-card-header>\n            <mat-card-title>\n                <h2>Login </h2>\n            </mat-card-title>\n        </mat-card-header>\n\n        <hr />\n\n        <div class=\"row \">\n\n            <div class=\"col-xs-11\">\n\n                <form class=\"row center-xs\" [formGroup]=\"RegisterFormGroup\">\n\n                    <mat-form-field class=\"col-xs-12\">\n                        <input matInput placeholder=\"Email\" name=\"email\" formControlName=\"Name\" />\n                    </mat-form-field>\n\n                    <mat-form-field class=\"col-xs-12\">\n                        <input matInput placeholder=\"Password\" type=\"password\" formControlName=\"Password\" />\n                        <mat-error *ngIf=\"!passwordsMatch\">\n                            Passwords must match\n                        </mat-error>\n                    </mat-form-field>\n\n                    <mat-form-field class=\"col-xs-12\">\n                        <input matInput placeholder=\"PasswordVerify\" type=\"password\" formControlName=\"PasswordVerify\" />\n                        <mat-error *ngIf=\"!passwordsMatch\">\n                            Passwords must match\n                        </mat-error>\n                    </mat-form-field>\n\n                    <div class=\"col-xs-12 start-xs\">\n                        <button mat-raised-button (click)=\"login()\" color=\"primary\"> Register </button>\n                    </div>\n\n                </form>\n            </div>\n        </div>\n    </mat-card>\n\n</div>"
...
var RegistrationComponent = /** @class */ (function () {
    ...
    RegistrationComponent.prototype.ngOnInit = function () {
        this.RegisterFormGroup = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormGroup */]({
            ...
            PasswordVerify: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */]('')
        });
        this.passwordsMatch = true;
        this.passwordListener();
        this.passworVerifydListener();
    };
    RegistrationComponent.prototype.passwordsMatchValidator = function () {
        var passwordControl = this.RegisterFormGroup.controls.Password;
        var passwordVerifyControl = this.RegisterFormGroup.controls.PasswordVerify;
    ...
    RegistrationComponent.prototype.passwordListener = function () {
        var _this = this;
        var passwordControl = this.RegisterFormGroup.controls.Password;
        passwordControl.valueChanges.subscribe(function (newPasswordValue) {
            _this.passwordsMatchValidator();
        });
    };
    RegistrationComponent.prototype.passworVerifydListener = function () {
        var _this = this;
        var passwordVerifyControl = this.RegisterFormGroup.controls.PasswordVerify;
        passwordVerifyControl.valueChanges.subscribe(function (newPasswordValue) {
            _this.passwordsMatchValidator();
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__account_guards_account_guard__ = __webpack_require__("../../../../../src/app/account/guards/account.guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'account', component: __WEBPACK_IMPORTED_MODULE_4__account_account_component__["a" /* AccountComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_6__account_guards_account_guard__["a" /* AccountGuard */]]
    },
    {
        path: 'register', component: __WEBPACK_IMPORTED_MODULE_5__registration_registration_component__["a" /* RegistrationComponent */]
    }
];
var RoutingModule = /** @class */ (function () {
    function RoutingModule() {
...
var GuildService = /** @class */ (function () {
    ...
    GuildService.prototype.getRejectedApplications = function () {
    ...
    GuildService.prototype.rejectApplication = function (body) {
...
var UserService = /** @class */ (function () {
    function UserService(apiService, http, router) {
        ...
        this.blizzardAccessTokenStorageItem = 'blizzardAccessToken';
        this.blizzardProfileStorageItem = 'blizzardProfile';
    }
    ...
    UserService.prototype.checkIfNewAccount = function (oauthId) {
    ...
    UserService.prototype.getOauthUser = function (oauthId) {
    ...
    UserService.prototype.oauthLogin = function (oauthId) {
        var body = {
            oauthId: oauthId
        };
